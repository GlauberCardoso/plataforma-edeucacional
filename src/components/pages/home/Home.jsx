...
export default function Home() {
  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://9ambx71ys2.execute-api.us-east-1.amazonaws.com/send-email", {
      method: "POST",
      headers: {
          ...
          <p>
            <div class="checkbox">
              <input
                type="checkbox"
                name="check"
                id="termo-privacidade"
                required
              />
              <label for="termo-privacidade">
                Li e concordo com a <Link to="/">Termos e Condições</Link> e{" "}
